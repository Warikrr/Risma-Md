...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '© Revky'
        global.colong1 = 'Tod R'
        global.colong2 = 'Tod R'
        global.kontak2 = [
        ['6281802857821', 'Revky', 'Chan', 'no thanks', true],
        ['6281802857821', await this.getName('6281802857821@s.whatsapp.net'), 'RevkyChan', 'no thanks', true], 
        ]
